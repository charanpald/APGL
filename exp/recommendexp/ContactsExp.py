...
from exp.recommendexp.ContactsDataset import ContactsDataset
...
# data
generator = ContactsDataset(maxIter=dataArgs.maxIter, iterStartTimeStamp=dataArgs.iterStartTimeStamp)
