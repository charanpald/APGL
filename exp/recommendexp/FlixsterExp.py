...
"""
Run some experiments using the Flixster dataset 
"""
import os
import sys
import errno
...
defaultAlgoArgs.ks = numpy.array(2**numpy.arange(3, 7.5), numpy.int) 
...
dataArgs.extendedDirName += "FlixsterDataset"

# print args #
logging.info("Running on FlixsterDataset")
...
# data
generator = FlixsterDataset(maxIter=dataArgs.maxIter, iterStartTimeStamp=dataArgs.iterStartTimeStamp)
