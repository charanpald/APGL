...
for datasetName, numRealisations in datasets: 
    ...
    plt.plot(x, meanCvGrid[1, :], label="PenVF")
    #plt.plot(x, meanCvGrid[2, :], label="Corrected Pen")
    plt.plot(x, meanCvGrid[3, :], label="PenVF+")
    plt.plot(testx, meanCvGrid[4, :], label="Test")
    plt.plot(x, meanCvGrid[5, :], label="Train")
    plt.xlabel("log(||w||)")
    ...
    plt.figure(figInd)
    plt.plot(x, meanPenalties, label="PenVF")
    #plt.plot(x, meanCorrectedPenalties, label="Corrected Penalty")
    plt.plot(x, meanBetaPenalties, label="PenVF+")
    plt.plot(testx, meanIdealPenalities, label="Ideal")
    plt.plot(x, meanTrainError, label="Train Error")
