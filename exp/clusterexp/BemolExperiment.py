...
algoArgs = argparse.Namespace()
#algoArgs.runIASC = True
#algoArgs.runExact = True
#algoArgs.runModularity = True
#algoArgs.runNystrom = True
#algoArgs.runNing = True
...
# data args parser #
dataParser = argparse.ArgumentParser(description="")
...
clusterExpHelper = ClusterExpHelper(getIterator, numGraphs, remainingArgs, algoArgs)
